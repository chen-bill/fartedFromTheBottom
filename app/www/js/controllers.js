...
.controller('settingsController', function($scope, $cordovaBluetoothLE, $rootScope) {
  ...
  $scope.debug2 = "Initialize : " + JSON.stringify(params);
  ...
  $scope.connect = function(obj) {
    // var address = "98:D3:31:50:20:C8";
    // $scope.debug2 = address;
    $scope.debug2 = 'connecting';
...
.controller('stinkController', function($scope, $cordovaBluetoothLE, $rootScope) {
  ...
  $scope.stink = function() {
    var params = {"value":"a","serviceUuid":"180F","characteristicUuid":"2A19","type":"noResponse"};
  ...
  function writeError(obj) {
    $scope.debug = "Spray Error : " + JSON.stringify(obj);
  }
